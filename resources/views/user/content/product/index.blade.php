        ...
        <div id="sidebar" class="col-span-3 px-2">
            <div class="w-full rounded-lg mb-4">
                <div id="category-title" class="bg-[#3ba66b] px-3 py-4 rounded-t-[12px] text-base text-white font-bold">
                    ...
                    @else
                        {{ mb_strtoupper($category->parent->name)}}
                    @endif
                </div>
                    ...
                    <ul>
                        @if($category->parent_id==0)
                            @foreach($category->subCategories as $item)
                                <a href="{{route('user.product.category',['slug'=> $item->slug])}}" class="hover:text-[#ffb416]">
                                    <li class="py-1.5">
                                        {{$item->name}}
                                    </li>
                                </a>
                            @endforeach
                        @else
                            @foreach($category->parent->subCategories as $item)
                                <a href="{{route('user.product.category',['slug'=> $item->slug])}}" class="hover:text-[#ffb416]">
                                    <li class="py-1.5">
                                            {{$item->name}}
                                    </li>
            ...
            <div class="w-full rounded-lg ">
                ...
                <div id="sub-filter" class="rounded-b-[12px] px-3 py-4  text-base border-2">
                    <ul>
                        <a href="{{route('user.product.category',['slug'=> $category->slug,...$query, 'max_price'=>"100000", 'min_price'=>"0"])}}">
                        ...
                        <a href="{{route('user.product.category',['slug'=> $category->slug,...$query, 'max_price'=>"200000", 'min_price'=>"100000"])}}">
                            <li class="p-2 hover:text-[#ffb416]">
                                <input type="checkbox" name="price" class="rounded-[2px] text-[#ffb416]" value="(<100000)" @if (isset($query['max_price']))
                        ...
                        <a href="{{route('user.product.category',['slug'=> $category->slug,...$query, 'max_price'=>"300000", 'min_price'=>"200000"])}}">
                            <li class="p-2 hover:text-[#ffb416]">
                                <input type="checkbox" name="price" class="rounded-[2px] text-[#ffb416]" value="(<100000)" @if (isset($query['max_price']))
                        ...
                        <a href="{{route('user.product.category',['slug'=> $category->slug,...$query, 'max_price'=>"500000", 'min_price'=>"300000"])}}">
                            <li class="p-2 hover:text-[#ffb416]">
                                <input type="checkbox" name="price" class="rounded-[2px] text-[#ffb416]" value="(<100000)" @if (isset($query['max_price']))
                        ...
                        <a href="{{route('user.product.category',['slug'=> $category->slug,...$query, 'max_price'=>"1000000", 'min_price'=>"500000"])}}">
                            <li class="p-2 hover:text-[#ffb416]">
                        ...
                        <a href="{{route('user.product.category',['slug'=> $category->slug,...$query, 'max_price'=>"2000000", 'min_price'=>"1000000"])}}">
                            <li class="p-2 hover:text-[#ffb416]">
                                <input type="checkbox" name="price" class="rounded-[2px] text-[#ffb416]" value="" @if (isset($query['max_price']))
                        ...
                        <a href="{{route('user.product.category',['slug'=> $category->slug,...$query, 'max_price'=>"3000000", 'min_price'=>"3000000"])}}">
                            <li class="p-2 hover:text-[#ffb416]">
                                <input type="checkbox" name="price" class="rounded-[2px] text-[#ffb416]" value="" @if (isset($query['max_price']))
                        ...
                        <a href="{{route('user.product.category',['slug'=> $category->slug,...$query, 'max_price'=>"9999999999", 'min_price'=>"3000000"])}}">
                            <li class="p-2 hover:text-[#ffb416]">
                                <input type="checkbox" name="price" class="rounded-[2px] text-[#ffb416]" value="" @if (isset($query['max_price']))
        ...
        <div class="col-span-9 px-2">
            <div id="filter-product" class="flex p-3 text-xl border-gray-200 border-b-2 mb-4">
                <div class="mr-4 @if(isset($query['name'])&&$query['name']=="ASC") text-yellow-500 @endif">
                    <a href="{{route('user.product.category',['slug'=> $category->slug,...$query, 'name'=>"ASC"])}}">
                        <i class="fa-solid fa-arrow-down-a-z"></i>
                    </a>
                </div>
                <div class="mr-4 @if(isset($query['name'])&&$query['name']=="DESC") text-yellow-500 @endif">
                    <a href="{{route('user.product.category',['slug'=> $category->slug,...$query, 'name'=>"DESC"])}}">
                        <i class="fa-solid fa-arrow-up-a-z"></i>
                    </a>
                </div>
                <div class="mr-4 @if(isset($query['price'])&&$query['price']=="ASC") text-yellow-500 @endif">
                    <a href="{{route('user.product.category',['slug'=> $category->slug,...$query, 'price'=>"ASC"])}}">
                ...
                <div class="mr-4 @if(isset($query['price'])&&$query['price']=="DESC") text-yellow-500 @endif">
                    <a href="{{route('user.product.category',['slug'=> $category->slug,...$query, 'price'=>"DESC"])}}">
