            ...
            <div class="mt-5">
                <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                    ...
                    <div class="w-full mt-3 xl:mt-0 flex-1">
                        <input id="product-name" type="text" class="form-control" name="name" placeholder="Product name">
                    </div>
                </div>
                <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                    <div class="form-label xl:w-64 xl:!mr-10">
                        ...
                        <div class="">
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="flex">
                                    ...
                                    <div >
                                        <img src="https://t4.ftcdn.net/jpg/04/73/25/49/360_F_473254957_bxG9yf4ly7OBO5I0O5KABlN930GwaMQz.jpg" id="img_preview" class="ml-5  h-24 w-48">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                    ...
                    <div class="w-full mt-3 xl:mt-0 flex-1">
                        <input id="product-name" type="text" class="form-control" name="link" placeholder="Product name">
                    </div>
                </div>
                <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                    <div class="form-label xl:w-64 xl:!mr-10">
                    ...
                    <div class="w-full mt-3 xl:mt-0 flex-1">
                        <select class="tom-select w-full form-control" name="status">
                            <option class="form-control" value="active" selected>Hiển Thị</option>
                            <option class="form-control" value="inactive">Không hiển Thị</option>
                        </select>
                    </div>
                </div>
