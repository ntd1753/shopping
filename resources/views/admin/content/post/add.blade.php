            ...
            <div class=" p-5">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="mt-5 ">
                        ...
                        <div >
                            <img src="https://t4.ftcdn.net/jpg/04/73/25/49/360_F_473254957_bxG9yf4ly7OBO5I0O5KABlN930GwaMQz.jpg" id="img_preview" class="ml-5 mt-5 h-24 w-24">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="intro-y box p-5 mt-5 grid grid-cols-2 gap-4">
            <div>
                ...
                <div class="mt-3">
                    ...
                    <textarea class="form-control  mt-2" id="content" name="description" placeholder="Nhập nội dung ....." ></textarea>
                </div>
            </div>
            <div>
                <div class="">
                ...
                <div class="mt-3">
                    ...
                    <textarea class="form-control  mt-2" id="Seo" name="seo_description" placeholder="Nhập nội dung ....." ></textarea>
                </div>
            </div>
        </div>
        <div class="intro-y box p-5 mt-5">
